        ...
        if (!tour) {
            const fetchTourDetails = async () => {
                try {
                    ...
                    const response = await fetch(`${process.env.REACT_APP_API_URL}/api/tours/${state?.selectedTour?._id}`,{headers:{"x-api-key": process.env.REACT_APP_API_KEY, "Authorization": `Bearer ${token}`}});
