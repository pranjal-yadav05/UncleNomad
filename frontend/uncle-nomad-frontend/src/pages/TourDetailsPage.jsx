...
const TourDetailsPage = () => {
  ...
  const getPricingInfo = () => {
    ...
    if (tour.priceOptions && Object.keys(tour.priceOptions).length > 0) {
      const prices = Object.values(tour.priceOptions).map((p) => Number.parseInt(p))
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${tour.images[0] || "/placeholder.svg?height=800&width=1200"})`,
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700">
                    {tour.inclusions?.slice(0, 5).map((inclusion, index) => <li key={index}>{inclusion}</li>) || (
                      <>
                ...
                <ImageGallery images={tour.images} onImageClick={handleImageClick} />
              </div>
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden sticky top-24">
                  ...
                  <div className="p-6">
                    <p className="text-gray-700 mb-6">
                      Secure your spot with a small deposit and pay the rest later. Spots fill quickly!
                    </p>
                    ...
                    <div className="mt-4 text-center">
                      <p className="text-sm text-gray-500">
                        Only {tour.availableSlots || "limited"} spots left for this experience
                      </p>
                    </div>
              ...
              <div className="space-y-8">
                {tour.itinerary &&
                  tour.itinerary.map((day, index) => (
                    <ItineraryDay key={day._id || index} day={day} isLast={index === tour.itinerary.length - 1} />
                  ))}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Join us on this incredible journey through {tour.location}. Limited spaces available for this exclusive
              experience.
            </p>
