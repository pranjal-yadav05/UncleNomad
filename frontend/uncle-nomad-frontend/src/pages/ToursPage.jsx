...
import { Calendar, Grid3X3, List, MapPin, Search, SlidersHorizontal, Users, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function ToursPage() {
  ...
  useEffect(() => {
    ...
    if (sortBy === "date") {
      ...
      result.sort((a, b) => (b.groupSize - b.bookedSlots) - (a.groupSize - a.bookedSlots));
    }
    
    setFilteredTours(result);
    // Reset to first page when filters change
    setCurrentPage(1);
  }, [tours, activeCategory, searchQuery, priceRange, durationRange, sortBy]);

  // Handle pagination
  useEffect(() => {
    // Calculate total pages
    const pages = Math.ceil(filteredTours.length / itemsPerPage);
    setTotalPages(pages || 1); // Ensure at least 1 page even if no results
    ...
    setPaginatedTours(currentItems);
      ...
      <main className="flex-grow">
        ...
        <div className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20 text-center">
            <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-6" style={{ fontFamily: "Poppins" }}>
              Discover Our Adventures
            </h1>
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
              Handcrafted journeys to the most breathtaking destinations across India and beyond
            </p>
            
            <div className="max-w-3xl mx-auto bg-white/10 backdrop-blur-md rounded-full p-2 flex items-center">
              <Input
                type="text"
              ...
              />
              <button className="p-3 flex rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          {/* Advanced filters */}
          {showFilters && (
            <div className="bg-white/5 backdrop-blur-md rounded-xl p-6 mb-8 border border-white/10 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                    ...
                    >
                      ...
                      <div className="p-5 flex-grow flex flex-col">
                        <div className="flex items-start justify-between mb-2">
                          <h3 className="text-xl font-bold text-white line-clamp-1">{tour.title}</h3>
                        </div>
                        ...
                        <div className="mt-auto flex justify-between items-center">
                          ...
                          <div className="text-xl font-bold text-white">₹{parseInt(tour.price).toLocaleString()}</div>
                        </div>
                      </div>
                    </div>
                  ))}
                  ...
                  {paginatedTours.map((tour) => (
                    ...
                    >
                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        ...
                        <p className="text-white/80 mb-4 line-clamp-3">{tour.description}</p>
            ...
            <div className="flex justify-center mt-12">
              <div className="flex items-center space-x-2">
                ...
                {getPageNumbers().map((page, index) => (
                  page === '...' ? (
                    <span key={`ellipsis-${index}`} className="text-white/50 px-2">...</span>
                  ) : (
                    <Button 
                      key={`page-${page}`}
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="bg-gradient-to-r from-purple-900/40 to-indigo-900/40 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-indigo-500/20">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Stay Updated on New Adventures</h2>
              <p className="text-indigo-200 mb-8">
                Subscribe to our newsletter and be the first to know about exclusive deals and upcoming expeditions
              </p>
              <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
                ...
                />
                <Button disabled={subscribing} onClick={handleSubscribe} className="bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700">
                  {subscribing ? "Subscribing..." : "Subscribe"}
                </Button>
                
              </div>
              {showConfirm && <i className="text-green-500 mt-5">Thanks for Subscribing...</i>}
            </div>
          </div>
        </div>
      </main>
