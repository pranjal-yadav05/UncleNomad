...
import { CalendarDaysIcon, UserIcon, ArrowLeftIcon, CreditCardIcon, UserCircleIcon } from "@heroicons/react/24/outline"
...
import BookingFailedDialog from "../modals/BookingFailedDialog" // Import the missing component
...
const RoomBookingPage = () => {
  ...
  const { bookingForm: initialBookingForm, availableRooms } = location.state || {}
  ...
  const verifyOtp = async (e) => {
    ...
    try {
      ...
      // Wait to ensure storage update
      await new Promise((resolve) => setTimeout(resolve, 200))

      window.dispatchEvent(new Event("storage")) // Sync token across tabs
  ...
  return (
    <AnimatedSection animation="fade-in" duration={800}>
      ...
      <div className="relative bg-blue-900 py-12">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            <h1 className="text-3xl md:text-4xl font-bold mb-3">Complete Your Booking</h1>
            <p className="text-lg opacity-80 max-w-2xl mx-auto">
              Just a few more details to confirm your stay from {formatDate(bookingForm.checkIn)} to{" "}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className={`bg-gray-100 ${validationErrors.guestName ? "border-red-500" : ""}`}
                      />
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          <Input
                            ...
                            required
                            readOnly={!!localStorage.getItem("authToken")} // Make read-only if logged in
                            className={`bg-gray-100 ${validationErrors.email ? "border-red-500" : ""}`}
                          />
                          {!localStorage.getItem("authToken") && (
                            <Button
                              type="button"
                              onClick={sendOtp}
                              disabled={
                                !validateEmail(bookingForm.email) || isSendingOtp || isOtpVerified || otpResendTimer > 0
                              }
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange} // Phone remains editable
                        required
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          {bookingForm.email} • {bookingForm.phone}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium">
                          {bookingForm.numberOfGuests} guests • {calculateNights()} nights
                        </p>
                        <p className="text-sm text-gray-500">
                          {bookingForm.mealIncluded ? "Meals included" : "No meals"}
                          {bookingForm.extraBeds > 0 ? ` • ${bookingForm.extraBeds} extra bed(s)` : ""}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start text-sm">
                    ...
                    <div>
                      <p className="font-medium">
                        {bookingForm.numberOfGuests || 1} guest{(bookingForm.numberOfGuests || 1) !== 1 ? "s" : ""}
                      </p>
                      {bookingForm.numberOfChildren > 0 && (
                        <p className="text-gray-500">{bookingForm.numberOfChildren} children</p>
                      )}
                    </div>
                  </div>
      ...
      {isPaymentActive && <div className="fixed inset-0 bg-black bg-opacity-50 z-40" aria-hidden="true"></div>}
