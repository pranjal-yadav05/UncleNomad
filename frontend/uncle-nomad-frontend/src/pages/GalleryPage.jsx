              ...
              <div className="tabs-container">
                ...
                <div className="tab-list">
                  {folders.map((folder, index) => (
                    <button
                      key={folder.name}
                      className={`tab-button ${activeFolder === folder.name ? "active" : ""}`}
                ...
                <div className="tab-content">
                  {folders.map((folder) => (
                    <div key={folder.name} className={`tab-panel ${activeFolder === folder.name ? "active" : ""}`}>
                      {activeFolder === folder.name && (
                        ...
                        >
                          ...
                          {imagesByFolder[folder.name] && imagesByFolder[folder.name].length > 0 ? (
                            <div className="relative">
                              <button
                            ...
                            <div className="flex items-center justify-center h-48 text-gray-400">
                              {imagesByFolder[folder.name] ? "No images found in this folder" : "Loading images..."}
                            </div>
                          )}
                        </motion.div>
                      )}
