  ...
  if (reviews.length === 0) {
    return (
      <section className="relative py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto max-w-5xl text-center">
          <div
            className="mb-3 text-center relative inline-block"
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            No reviews available at the moment. Be the first to share your
            experience!
          </p>
        </div>
      </section>
    ...
    <section className="relative py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-12 flex flex-col items-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover the experiences of our valued guests who have stayed with
            us
          </p>
        </div>
                        ...
                        <div className="h-12 w-12 border-2 border-blue-100 flex-shrink-0">
                          <img
                            src={`https://api.dicebear.com/7.x/initials/svg?seed=${
                              review.author_name ? review.author_name[0] : "U"
                            }`}
